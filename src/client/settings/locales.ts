...
export const en: Record<DataSourcesSettingsLocaleKey, string> = {
  ...
  fieldPasswordEnvTooltip: 'Name of an environment variable on the host process holding the password. Must start with DSH_DA_. The password itself is never stored or sent here.',
...
export const zh: Record<DataSourcesSettingsLocaleKey, string> = {
  ...
  fieldPasswordEnvTooltip: '存放密码的宿主进程环境变量名称，必须以 DSH_DA_ 开头。密码本身不会被存储或发送到此处。',
  fieldDatabase: '数据库',
  fieldSsl: 'SSL',
  fieldSslMode: 'SSL 模式',
